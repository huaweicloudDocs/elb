# 删除健康检查<a name="DeleteHealthMonitor"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=ELB&api=DeleteHealthMonitor)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。

## URI

DELETE /v3/\{project\_id\}/elb/healthmonitors/\{healthmonitor\_id\}
