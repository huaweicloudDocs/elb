...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=ELB&api=ListCertificates)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。

## URI

GET /v3/\{project\_id\}/elb/certificates
...
<p>支持多值查询，查询条件格式：domain=xxx&amp;domain=xxx。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>证书的类型。分为服务器证书(server)和CA证书(client)。</p>
<p>支持多值查询，查询条件格式：type=xxx&amp;type=xxx。</p>
</td>
</tr>
</tbody>
</table>
...
<a name="response_ListCertificatesResponseBody"></a>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>证书分页信息。</p>
</td>
</tr>
<tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.1 "><p>certificates</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.2 "><p>Array of <a href="#response_CertificateInfo">CertificateInfo</a> objects</p>
</td>
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>证书对象列表。</p>
</td>
</tr>
</tbody>
</table>
