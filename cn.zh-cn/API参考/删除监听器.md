...
删除listener之前必须删除或解绑与其关联的pool，删除与其关联的l7policy。

## 调试<a name="atuogenerate_1"></a>

您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=ELB&api=DeleteListener)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。

## URI

DELETE /v3/\{project\_id\}/elb/listeners/\{listener\_id\}
