# 查询IP地址组列表<a name="ListIpGroups"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=ELB&api=ListIpGroups)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。

## URI

GET /v3/\{project\_id\}/elb/ipgroups
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>IP地址组的ID。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>IP地址，多个用逗号分隔。</p>
</td>
</tr>
</tbody>
</table>
...
<a name="response_ListIpGroupsResponseBody"></a>
...
<tbody><tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.1 "><p>ipgroups</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.2 "><p>Array of <a href="#response_IpGroup">IpGroup</a> objects</p>
</td>
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>IP地址组列表返回对象。</p>
</td>
</tr>
