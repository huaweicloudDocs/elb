...
<td class="cellrowborder" valign="top" width="26.5%" headers="mcps1.2.5.1.2 "><p id="zh-cn_topic_0121682347_p1586811163312"><a name="zh-cn_topic_0121682347_p1586811163312"></a><a name="zh-cn_topic_0121682347_p1586811163312"></a>project id，项目编号。请参考<a href="获取项目ID.md#elb_fl_0008">获取项目ID</a>章节获取项目编号。</p>
</td>
...
>AK/SK认证的详细说明请参见[认证鉴权](认证鉴权.md#elb_dy_0003)的“AK/SK认证”。
