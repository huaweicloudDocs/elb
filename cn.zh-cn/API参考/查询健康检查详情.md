# 查询健康检查详情<a name="ShowHealthMonitor"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=ELB&api=ShowHealthMonitor)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。

## URI

GET /v3/\{project\_id\}/elb/healthmonitors/\{healthmonitor\_id\}
...
<a name="response_ShowHealthMonitorResponseBody"></a>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>监看检查对象。</p>
</td>
</tr>
</tbody>
</table>
