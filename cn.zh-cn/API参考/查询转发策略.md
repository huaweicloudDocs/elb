# 查询转发策略<a name="zh-cn_topic_0136295315"></a>
...
<td class="cellrowborder" colspan="2" valign="top" headers="mcps1.2.6.1.4 "><p id="p163282306342"><a name="p163282306342"></a><a name="p163282306342"></a>分页查询每页的转发策略个数。</p>
...
<td class="cellrowborder" colspan="2" valign="top" headers="mcps1.2.6.1.4 "><p id="p09321236141419"><a name="p09321236141419"></a><a name="p09321236141419"></a>转发策略所在的项目ID。</p>
...
<p id="p1421417231357"><a name="p1421417231357"></a><a name="p1421417231357"></a>该字段为预留字段，暂未启用。默认为true。</p>
</td>
</tr>
...
<td class="cellrowborder" colspan="2" valign="top" headers="mcps1.2.6.1.4 "><p id="p14704205693714"><a name="p14704205693714"></a><a name="p14704205693714"></a>转发策略的配置状态，可以为ACTIVE、PENDING_CREATE 或者ERROR。</p>
...
<p id="p207341733192010"><a name="p207341733192010"></a><a name="p207341733192010"></a>支持的最大字符长度：16</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="18.18%" headers="mcps1.2.4.1.2 "><p id="p9101532352"><a name="p9101532352"></a><a name="p9101532352"></a>String</p>
</td>
...
<tr id="row5702175643718"><td class="cellrowborder" valign="top" width="23.23%" headers="mcps1.2.4.1.1 "><p id="p423345441210"><a name="p423345441210"></a><a name="p423345441210"></a>tenant_id</p>
</td>
...
<td class="cellrowborder" valign="top" width="58.589999999999996%" headers="mcps1.2.4.1.3 "><p id="p923755481211"><a name="p923755481211"></a><a name="p923755481211"></a>转发策略所在的项目ID。</p>
<p id="p189295742214"><a name="p189295742214"></a><a name="p189295742214"></a>支持的最大字符长度：255</p>
</td>
</tr>
<tr id="row161321221111411"><td class="cellrowborder" valign="top" width="23.23%" headers="mcps1.2.4.1.1 "><p id="p102418544129"><a name="p102418544129"></a><a name="p102418544129"></a>project_id</p>
</td>
...
<td class="cellrowborder" valign="top" width="58.589999999999996%" headers="mcps1.2.4.1.3 "><p id="p10245165412128"><a name="p10245165412128"></a><a name="p10245165412128"></a>转发策略所在的项目ID。</p>
</td>
</tr>
...
<p id="p1532011232"><a name="p1532011232"></a><a name="p1532011232"></a>支持的最大字符长度：255</p>
</td>
</tr>
...
<p id="p1241002122314"><a name="p1241002122314"></a><a name="p1241002122314"></a>支持的最大字符长度：255</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="18.18%" headers="mcps1.2.4.1.2 "><p id="p1637154512510"><a name="p1637154512510"></a><a name="p1637154512510"></a>String</p>
</td>
...
<td class="cellrowborder" valign="top" width="18.18%" headers="mcps1.2.4.1.2 "><p id="p1250115531251"><a name="p1250115531251"></a><a name="p1250115531251"></a>String</p>
</td>
...
<td class="cellrowborder" valign="top" width="18.18%" headers="mcps1.2.4.1.2 "><p id="p1422311551851"><a name="p1422311551851"></a><a name="p1422311551851"></a>String</p>
</td>
...
<td class="cellrowborder" valign="top" width="58.589999999999996%" headers="mcps1.2.4.1.3 "><p id="p832245451219"><a name="p832245451219"></a><a name="p832245451219"></a>转发策略重定向到的url。</p>
<p id="p132355414127"><a name="p132355414127"></a><a name="p132355414127"></a>该字段为预留字段，暂未启用。</p>
<p id="p1873163917238"><a name="p1873163917238"></a><a name="p1873163917238"></a>支持的最大字符长度：255</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="58.589999999999996%" headers="mcps1.2.4.1.3 "><p id="p17125144555018"><a name="p17125144555018"></a><a name="p17125144555018"></a>转发策略关联的转发规则的ID列表。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="58.589999999999996%" headers="mcps1.2.4.1.3 "><p id="p18338205419126"><a name="p18338205419126"></a><a name="p18338205419126"></a>转发优先级，从1递增，最高100。默认值：100；</p>
<p id="p133915461210"><a name="p133915461210"></a><a name="p133915461210"></a>该字段为预留字段，暂未启用。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="58.589999999999996%" headers="mcps1.2.4.1.3 "><p id="p934715461215"><a name="p934715461215"></a><a name="p934715461215"></a>转发策略的配置状态，可以为ACTIVE、PENDING_CREATE 或者ERROR。</p>
<p id="p1111194711237"><a name="p1111194711237"></a><a name="p1111194711237"></a>支持的最大字符长度：16</p>
<div class="note" id="note1950762816420"><a name="note1950762816420"></a><a name="note1950762816420"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="p550922834216"><a name="p550922834216"></a><a name="p550922834216"></a>该字段无实际含义，默认为ACTIVE。</p>
</div></div>
</td>
</tr>
<tr id="row1190111551316"><td class="cellrowborder" valign="top" width="23.23%" headers="mcps1.2.4.1.1 "><p id="zh-cn_topic_0096561531_p11729026152811"><a name="zh-cn_topic_0096561531_p11729026152811"></a><a name="zh-cn_topic_0096561531_p11729026152811"></a>l7policies_links</p>
</td>
<td class="cellrowborder" valign="top" width="18.18%" headers="mcps1.2.4.1.2 "><p id="p215116463169"><a name="p215116463169"></a><a name="p215116463169"></a>Array</p>
</td>
<td class="cellrowborder" valign="top" width="58.589999999999996%" headers="mcps1.2.4.1.3 "><p id="p5542991616"><a name="p5542991616"></a><a name="p5542991616"></a>转发策略的分页查询中上下页的链接信息。</p>
<p id="p165764116119"><a name="p165764116119"></a><a name="p165764116119"></a>仅当分页查询时响应体中有该字段。</p>
<p id="p53635145114"><a name="p53635145114"></a><a name="p53635145114"></a>详见<a href="#table164602247259">表4</a>。</p>
</td>
</tr>
</tbody>
</table>

**表 4**  l7policies\_links字段说明
...
## 示例<a name="section098062617334"></a>
