# 更新健康检查<a name="UpdateHealthMonitor"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=ELB&api=UpdateHealthMonitor)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。

## URI

PUT /v3/\{project\_id\}/elb/healthmonitors/\{healthmonitor\_id\}
...
<tbody><tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.1 "><p>healthmonitor_id</p>
</td>
...
<a name="request_UpdateHealthMonitorRequestBody"></a>
<table><thead align="left"><tr><th class="cellrowborder" valign="top" width="20%" id="mcps1.2.5.1.1"><p>参数</p>
</th>
<th class="cellrowborder" valign="top" width="20%" id="mcps1.2.5.1.2"><p>是否必选</p>
</th>
...
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.3 "><p><a href="#request_UpdateHealthMonitorOption">UpdateHealthMonitorOption</a> object</p>
</td>
...
**表 4**  UpdateHealthMonitorOption

<a name="request_UpdateHealthMonitorOption"></a>
<table><thead align="left"><tr><th class="cellrowborder" valign="top" width="20%" id="mcps1.2.5.1.1"><p>参数</p>
</th>
<th class="cellrowborder" valign="top" width="20%" id="mcps1.2.5.1.2"><p>是否必选</p>
</th>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>健康检查间隔。健康检查间隔。取值：1-50s。</p>
...
<p>取值：以数字或字母开头，只能包含数字、字母、’-’、’.’。 不能传空，但可传null或不传，表示使用负载均衡器的vip作为http请求的目的地址。</p>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>健康检查端口号。取值：1-65535，不可传入空，但可传入null，表示使用后端云服务器端口号。</p>
<p>最小值：<strong>1</strong></p>
...
<a name="response_UpdateHealthMonitorResponseBody"></a>
...
<td class="cellrowborder" valign="top" width="85%" headers="mcps1.1.3.1.2 "><p>1.无效的请求Body体。 2.无效的请求参数访问。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="85%" headers="mcps1.1.3.1.2 "><p>请求头部太大。</p>
</td>
</tr>
