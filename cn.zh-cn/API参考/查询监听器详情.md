...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=ELB&api=ShowListener)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。

## URI

GET /v3/\{project\_id\}/elb/listeners/\{listener\_id\}
...
<a name="response_ShowListenerResponseBody"></a>
