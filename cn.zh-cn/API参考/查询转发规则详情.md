...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=ELB&api=ShowL7Rule)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。

## URI

GET /v3/\{project\_id\}/elb/l7policies/\{l7policy\_id\}/rules/\{l7rule\_id\}
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>7层转发策略。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>7层转发规则。</p>
</td>
</tr>
</tbody>
</table>
...
<a name="response_ShowL7RuleResponseBody"></a>
