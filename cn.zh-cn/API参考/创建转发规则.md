...
-   如果 l7policy 是重定向到listener的话，不允许创建l7rule。


## 调试<a name="atuogenerate_1"></a>

您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=ELB&api=CreateL7Rule)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。

## URI

POST /v3/\{project\_id\}/elb/l7policies/\{l7policy\_id\}/rules
...
<a name="request_CreateL7RuleRequestBody"></a>
<table><thead align="left"><tr><th class="cellrowborder" valign="top" width="20%" id="mcps1.2.5.1.1"><p>参数</p>
</th>
<th class="cellrowborder" valign="top" width="20%" id="mcps1.2.5.1.2"><p>是否必选</p>
</th>
...
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.3 "><p><a href="#request_CreateRuleOption">CreateRuleOption</a> object</p>
</td>
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>转发规则对象。</p>
</td>
</tr>
</tbody>
</table>

**表 4**  CreateRuleOption
...
<a name="response_CreateL7RuleResponseBody"></a>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>转发规则对象。</p>
</td>
</tr>
</tbody>
</table>
