# 添加UDP监听器<a name="zh-cn_topic_0167652122"></a>

## 操作场景<a name="section13358194520513"></a>

UDP协议适用于关注实时性而相对不注重可靠性的场景，如视频聊天、游戏、金融实时行情推送。您可以添加一个UDP监听器转发来自UDP协议的请求。

目前经典型私网负载均衡不支持添加UDP监听器，仅增强型负载均衡和经典型公网负载均衡支持添加UDP监听器。

## 添加增强型负载均衡UDP监听器<a name="section18262194013551"></a>

1.  登录管理控制台。
2.  在管理控制台左上角单击![](figures/zh-cn_image_0167652148.jpg)图标，选择区域和项目。
3.  选择“服务列表 \> 网络 \> 弹性负载均衡”。
...
6.  配置监听器参数参见[表1](#table20377204713512)，单击“下一步”。
    ...
    **表 1**  增强型负载均衡配置监听器参数说明
    ...
    <p id="p1373124793517"><a name="p1373124793517"></a><a name="p1373124793517"></a>选择UDP协议，端口取值范围[1-65535]。</p>
    </td>
    <td class="cellrowborder" valign="top" width="29.86%" headers="mcps1.2.4.1.3 "><p id="p63739472356"><a name="p63739472356"></a><a name="p63739472356"></a>UDP/80</p>
    </td>
    </tr>
...
7.  配置后端服务器组参数参见[表2](#table3561446373)，配置健康检查参数参见[表3](#table95680412371)，单击“完成”。
    ...
    **表 2**  增强型负载均衡配置后端服务器组参数说明
    ...
    <tbody><tr id="row95561142372"><td class="cellrowborder" valign="top" width="23.419999999999998%" headers="mcps1.2.4.1.1 "><p id="p1255518414378"><a name="p1255518414378"></a><a name="p1255518414378"></a>后端<span id="text1169072265114"><a name="text1169072265114"></a><a name="text1169072265114"></a>服务器</span>组</p>
    </td>
    <td class="cellrowborder" valign="top" width="46.72%" headers="mcps1.2.4.1.2 "><p id="p1155517417374"><a name="p1155517417374"></a><a name="p1155517417374"></a>把具有相同特性的后端<span id="text087662945118"><a name="text087662945118"></a><a name="text087662945118"></a>服务器</span>放在一个组。</p>
    ...
    <td class="cellrowborder" valign="top" width="46.72%" headers="mcps1.2.4.1.2 "><p id="p155569413712"><a name="p155569413712"></a><a name="p155569413712"></a>后端<span id="text23904373519"><a name="text23904373519"></a><a name="text23904373519"></a>服务器</span>组名称。</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="46.72%" headers="mcps1.2.4.1.2 "><p id="p9556184133715"><a name="p9556184133715"></a><a name="p9556184133715"></a>云服务开通的协议。默认UDP。</p>
    </td>
    <td class="cellrowborder" valign="top" width="29.86%" headers="mcps1.2.4.1.3 "><p id="p3556348372"><a name="p3556348372"></a><a name="p3556348372"></a>UDP</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="46.72%" headers="mcps1.2.4.1.2 "><p id="p75601413375"><a name="p75601413375"></a><a name="p75601413375"></a>开启会话保持后，弹性负载均衡将属于同一个会话的请求都转发到同一个<span id="text177442473515"><a name="text177442473515"></a><a name="text177442473515"></a>服务器</span>进行处理。</p>
    <div class="note" id="note169761956101212"><a name="note169761956101212"></a><a name="note169761956101212"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="zh-cn_topic_0167652121_p15976856191215"><a name="zh-cn_topic_0167652121_p15976856191215"></a><a name="zh-cn_topic_0167652121_p15976856191215"></a>当分配策略类型为“加权轮询算法”时，可配置会话保持。</p>
    </div></div>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="46.72%" headers="mcps1.2.4.1.2 "><p id="p13790915163619"><a name="p13790915163619"></a><a name="p13790915163619"></a>UDP协议仅支持源IP地址类型。</p>
    <p id="p17901815113610"><a name="p17901815113610"></a><a name="p17901815113610"></a>源IP地址：相同的源IP地址的请求始终被分发到相同的后端服务器处理。这可以使得同一个客户端IP的请求始终被派发至某特定的服务器。</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="46.72%" headers="mcps1.2.4.1.2 "><p id="p9561204183712"><a name="p9561204183712"></a><a name="p9561204183712"></a>后端<span id="text9930566518"><a name="text9930566518"></a><a name="text9930566518"></a>服务器</span>组的描述。</p>
    </td>
    ...
    **表 3**  增强型负载均衡配置健康检查参数说明
    ...
    <td class="cellrowborder" valign="top" width="46.72%" headers="mcps1.2.4.1.2 "><p id="p18146932145919"><a name="p18146932145919"></a><a name="p18146932145919"></a>健康检查协议默认为UDP。</p>
    </td>
    <td class="cellrowborder" valign="top" width="29.86%" headers="mcps1.2.4.1.3 "><p id="p65626414372"><a name="p65626414372"></a><a name="p65626414372"></a>UDP</p>
    </td>
    </tr>
...
## 添加经典型负载均衡UDP监听器<a name="section7841311103416"></a>

1.  登录管理控制台。
2.  在管理控制台左上角单击![](figures/zh-cn_image_0167652149.jpg)图标，选择区域和项目。
3.  选择“服务列表 \> 网络 \> 弹性负载均衡”。
...
5.  在“监听器”区域，单击“添加监听器”，配置参数请参见[表4](#table3947759918410)。
    ...
    **表 4**  经典型负载均衡监听器参数说明
    ...
    <p id="p4401171514011"><a name="p4401171514011"></a><a name="p4401171514011"></a>当负载均衡的类型为公网时，选择UDP协议，端口取值范围[1，65535]。</p>
    </td>
    <td class="cellrowborder" valign="top" width="18.11%" headers="mcps1.2.4.1.3 "><p id="p49979242124539"><a name="p49979242124539"></a><a name="p49979242124539"></a>UDP/80</p>
    </td>
    </tr>
    ...
    <p id="p124415312016"><a name="p124415312016"></a><a name="p124415312016"></a>后端协议默认为UDP，端口取值范围[1，65535]。</p>
    </td>
    <td class="cellrowborder" valign="top" width="18.11%" headers="mcps1.2.4.1.3 "><p id="p66231138124610"><a name="p66231138124610"></a><a name="p66231138124610"></a>UDP/22</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="53.89000000000001%" headers="mcps1.2.4.1.2 "><p id="p62151950131513"><a name="p62151950131513"></a><a name="p62151950131513"></a>对后端云服务器进行健康检查的协议和端口。</p>
    <p id="p43198726162422"><a name="p43198726162422"></a><a name="p43198726162422"></a>协议默认为UDP, 端口取值范围[1，65535]。</p>
    <div class="note" id="note9781344114112"><a name="note9781344114112"></a><a name="note9781344114112"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="p20923240114112"><a name="p20923240114112"></a><a name="p20923240114112"></a>当健康检查是UDP时,后端云服务器的安全组必须开通ICMP协议。</p>
    </div></div>
    </td>
    <td class="cellrowborder" valign="top" width="18.11%" headers="mcps1.2.4.1.3 "><p id="p9435957162422"><a name="p9435957162422"></a><a name="p9435957162422"></a>UDP/80</p>
    </td>
    </tr>
