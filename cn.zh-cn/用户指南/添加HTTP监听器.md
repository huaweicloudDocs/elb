# 添加HTTP监听器<a name="zh-cn_topic_0167652123"></a>

## 操作场景<a name="section13358194520513"></a>

HTTP协议适用于需要对数据内容进行识别的应用，如Web应用、小的手机游戏等。您可以添加一个HTTP监听器转发来自HTTP协议的请求。

## 添加增强型负载均衡HTTP监听器<a name="section18262194013551"></a>

1.  登录管理控制台。
2.  在管理控制台左上角单击![](figures/zh-cn_image_0167652150.jpg)图标，选择区域和项目。
3.  选择“服务列表 \> 网络 \> 弹性负载均衡”。
...
6.  配置监听器参数参见[表1](#table20377204713512)，单击“下一步”。
    ...
    **表 1**  增强型负载均衡配置监听器参数说明
    ...
    <td class="cellrowborder" valign="top" width="46.72%" headers="mcps1.2.4.1.2 "><p id="p5427412122420"><a name="p5427412122420"></a><a name="p5427412122420"></a>负载分发的协议和端口。</p>
    <p id="p10373347163514"><a name="p10373347163514"></a><a name="p10373347163514"></a>选择HTTP协议，端口取值范围[1-65535]。</p>
    </td>
    <td class="cellrowborder" valign="top" width="29.86%" headers="mcps1.2.4.1.3 "><p id="p63739472356"><a name="p63739472356"></a><a name="p63739472356"></a>HTTP/80</p>
    </td>
    </tr>
    <tr id="row14373947133518"><td class="cellrowborder" valign="top" width="23.419999999999998%" headers="mcps1.2.4.1.1 "><p id="p937384710352"><a name="p937384710352"></a><a name="p937384710352"></a>重定向</p>
    </td>
    <td class="cellrowborder" valign="top" width="46.72%" headers="mcps1.2.4.1.2 "><p id="p1293052172513"><a name="p1293052172513"></a><a name="p1293052172513"></a>重定向开关是否开启。</p>
    ...
    <td class="cellrowborder" valign="top" width="29.86%" headers="mcps1.2.4.1.3 "><p id="p113737475359"><a name="p113737475359"></a><a name="p113737475359"></a>-</p>
    </td>
    </tr>
    <tr id="row3374174715359"><td class="cellrowborder" valign="top" width="23.419999999999998%" headers="mcps1.2.4.1.1 "><p id="p113736479357"><a name="p113736479357"></a><a name="p113736479357"></a>重定向至</p>
    </td>
    <td class="cellrowborder" valign="top" width="46.72%" headers="mcps1.2.4.1.2 "><p id="p1437424743517"><a name="p1437424743517"></a><a name="p1437424743517"></a>选择需要重定向HTTPS监听器的名称。</p>
    </td>
    <td class="cellrowborder" valign="top" width="29.86%" headers="mcps1.2.4.1.3 "><p id="p8374174733518"><a name="p8374174733518"></a><a name="p8374174733518"></a>-</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="46.72%" headers="mcps1.2.4.1.2 "><p id="p183751847203516"><a name="p183751847203516"></a><a name="p183751847203516"></a>可以自定义设置更多功能。</p>
    </td>
    ...
    <tr id="row8376247103520"><td class="cellrowborder" valign="top" width="23.419999999999998%" headers="mcps1.2.4.1.1 "><p id="p1937624713351"><a name="p1937624713351"></a><a name="p1937624713351"></a>获取弹性公网IP</p>
    </td>
    <td class="cellrowborder" valign="top" width="46.72%" headers="mcps1.2.4.1.2 "><p id="p7564183222719"><a name="p7564183222719"></a><a name="p7564183222719"></a>获取弹性公网IP是否开启。</p>
    <p id="p1837614713512"><a name="p1837614713512"></a><a name="p1837614713512"></a>可根据需要设置该项。若您需要将ELB公网IP透传到后端，只需在创建HTTP监听器时，打开该开关。</p>
    </td>
...
7.  配置后端服务器组参数参见[表2](#table3561446373)，配置健康检查参数参见[表3](#table95680412371)，单击“完成”。
    ...
    **表 2**  增强型负载均衡配置后端服务器组参数说明
    ...
    <tbody><tr id="row95561142372"><td class="cellrowborder" valign="top" width="23.419999999999998%" headers="mcps1.2.4.1.1 "><p id="p1255518414378"><a name="p1255518414378"></a><a name="p1255518414378"></a>后端<span id="text78271124195217"><a name="text78271124195217"></a><a name="text78271124195217"></a>服务器</span>组</p>
    </td>
    <td class="cellrowborder" valign="top" width="46.72%" headers="mcps1.2.4.1.2 "><p id="p1155517417374"><a name="p1155517417374"></a><a name="p1155517417374"></a>把具有相同特性的后端<span id="text1716773255211"><a name="text1716773255211"></a><a name="text1716773255211"></a>服务器</span>放在一个组。</p>
    ...
    <td class="cellrowborder" valign="top" width="46.72%" headers="mcps1.2.4.1.2 "><p id="p155569413712"><a name="p155569413712"></a><a name="p155569413712"></a>后端<span id="text823053845216"><a name="text823053845216"></a><a name="text823053845216"></a>服务器</span>组名称。</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="46.72%" headers="mcps1.2.4.1.2 "><p id="p75601413375"><a name="p75601413375"></a><a name="p75601413375"></a>开启会话保持后，弹性负载均衡将属于同一个会话的请求都转发到同一个<span id="text10679104655210"><a name="text10679104655210"></a><a name="text10679104655210"></a>服务器</span>进行处理。</p>
    <div class="note" id="note14560848376"><a name="note14560848376"></a><a name="note14560848376"></a><span class="notetitle"> 说明： </span><div class="notebody"><a name="ul18240191212514"></a><a name="ul18240191212514"></a><ul id="ul18240191212514"><li>当分配策略类型为“加权轮询算法”时，可配置会话保持。</li><li>对于HTTP类型的监听器，变更会话保持的状态可能会导致本监听器访问出现秒级中断。</li></ul>
    </div></div>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="46.72%" headers="mcps1.2.4.1.2 "><p id="p125601473720"><a name="p125601473720"></a><a name="p125601473720"></a>HTTP协议支持HTTP cookie和应用程序 cookie类型。用户可根据自身需求选择相应的会话保持方式来分配用户访问流量，提升负载均衡能力。</p>
    ...
    <td class="cellrowborder" valign="top" width="46.72%" headers="mcps1.2.4.1.2 "><p id="p9561204183712"><a name="p9561204183712"></a><a name="p9561204183712"></a>后端<span id="text9586185418528"><a name="text9586185418528"></a><a name="text9586185418528"></a>服务器</span>组的描述。</p>
    </td>
    ...
    **表 3**  增强型负载均衡配置健康检查参数说明
    ...
    <td class="cellrowborder" valign="top" width="46.72%" headers="mcps1.2.4.1.2 "><p id="p1960833344017"><a name="p1960833344017"></a><a name="p1960833344017"></a>健康检查支持TCP和HTTP方式，设置后不可修改。</p>
    </td>
    ...
    <tr id="row85581023131212"><td class="cellrowborder" valign="top" width="23.419999999999998%" headers="mcps1.2.4.1.1 "><p id="p1563841377"><a name="p1563841377"></a><a name="p1563841377"></a>域名</p>
    </td>
...
## 添加经典型负载均衡HTTP监听器<a name="section7841311103416"></a>

1.  登录管理控制台。
2.  在管理控制台左上角单击![](figures/zh-cn_image_0167652151.jpg)图标，选择区域和项目。
3.  选择“服务列表 \> 网络 \> 弹性负载均衡”。
...
5.  在“监听器”区域，单击“添加监听器”，配置参数请参见[表4](#table3947759918410)。
    ...
    **表 4**  经典型负载均衡监听器参数说明
    ...
    <p id="p444102312423"><a name="p444102312423"></a><a name="p444102312423"></a>选择HTTP协议，端口取值范围[1-65535]。</p>
    </td>
    <td class="cellrowborder" valign="top" width="18.11%" headers="mcps1.2.4.1.3 "><p id="p34532864101423"><a name="p34532864101423"></a><a name="p34532864101423"></a>HTTP/80</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="53.89000000000001%" headers="mcps1.2.4.1.2 "><p id="p18013237319"><a name="p18013237319"></a><a name="p18013237319"></a>云服务开通的协议和端口。</p>
    <p id="p15549454162422"><a name="p15549454162422"></a><a name="p15549454162422"></a>协议默认HTTP，端口取值范围[1，65535]。</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="53.89000000000001%" headers="mcps1.2.4.1.2 "><p id="p161987121866"><a name="p161987121866"></a><a name="p161987121866"></a>对后端云服务器进行健康检查的协议和端口。</p>
    <p id="p43198726162422"><a name="p43198726162422"></a><a name="p43198726162422"></a>健康检查支持TCP和HTTP协议，设置后不可修改。端口取值范围[1，65535]。</p>
    </td>
